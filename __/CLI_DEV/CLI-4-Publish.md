...
dotnet nuget push ./GLOB/GLOB.API.Config/bin/Release/GLOB.API.Config.1.0.0.nupkg --api-key your-key --source https://api.nuget.org/v3/index.json
...
dotnet nuget push ./GLOB/GLOB.API/bin/Release/GLOB.API.1.0.0.nupkg --api-key your-key --source https://api.nuget.org/v3/index.json
