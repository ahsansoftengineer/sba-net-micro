...
public static partial class API_DI_Common
{
  ...
  public static void Add_API_Config_Default_Srvc(this IServiceCollection srvc, IConfiguration config)
  {
  ...
  public static void Add_API_Config_Default_Srvc2(this IServiceCollection srvc)
  {
