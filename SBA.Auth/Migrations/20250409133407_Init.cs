    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "22c74fbc-9b0d-4848-85db-f09d58750006", 0, "d675faa0-c26f-458c-bcf9-b677559e0f4e", new DateTimeOffset(new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 0, 0, 0)), "InfraUser_1@yopmail.com", true, false, null, "InfraUser_1", "INFRAUSER_1@YOPMAIL.COM", "INFRAUSER_1@YOPMAIL.COM", "AQAAAAIAAYagAAAAEIiS0TzjuEEcA8CiomZmFozMnvV1LBD/P36P/yfi6gL1E02QPzE9OwVo7gykvWlbyA==", null, false, null, 0, false, new DateTimeOffset(new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 0, 0, 0)), "InfraUser_1@yopmail.com" },
                    { "46eb923d-8529-4b77-b311-96e98ea6ea06", 0, "c4956f30-ae45-4230-bb32-67c1588b180c", new DateTimeOffset(new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 0, 0, 0)), "InfraUser_2@yopmail.com", true, false, null, "InfraUser_2", "INFRAUSER_2@YOPMAIL.COM", "INFRAUSER_2@YOPMAIL.COM", "AQAAAAIAAYagAAAAEH2UfnCzP92uQYMszQP28wbmfJ+XoKlBpTvV9Qp6696nqS286Woz/cndgC8X6HO4dw==", null, false, null, 0, false, new DateTimeOffset(new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 0, 0, 0)), "InfraUser_2@yopmail.com" },
                    { "8118fea8-a644-4d67-9eca-1d689465a1bf", 0, "6cef2088-a379-4b81-a555-46dda34d3de0", new DateTimeOffset(new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 0, 0, 0)), "InfraUser_3@yopmail.com", true, false, null, "InfraUser_3", "INFRAUSER_3@YOPMAIL.COM", "INFRAUSER_3@YOPMAIL.COM", "AQAAAAIAAYagAAAAEI5k/HYk1J50VvfRuIIWY68PVpB3+7beFJc8jgcWvybFRTiPQTqcBUrx8E8OoxhwoQ==", null, false, null, 0, false, new DateTimeOffset(new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 0, 0, 0)), "InfraUser_3@yopmail.com" }
                });
