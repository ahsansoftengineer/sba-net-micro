...
namespace SBA.Auth.Migrations
{
    ...
    [Migration("20250401080651_SeedAuth")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GLOB.Domain.Auth.UserInfra", b =>
                {
            ...
            modelBuilder.Entity("GLOB.Domain.Auth.UserRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("GLOB.Domain.Auth.UserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GLOB.Domain.Auth.UserInfra", null)
                        .WithMany()
